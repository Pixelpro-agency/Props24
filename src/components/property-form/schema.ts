...
export const propertySchema = z.object({
    ...
    PropertyCadastreMunicipalityCode: stringField,
    PropertyCadastreRegistryType: z.enum(['', 'terreni', 'urbano']).default(''),
    PropertyCadastreMunicipality: stringField,
    ...
    PropertyCadastreDocument: storedLocalFileSchema.nullable().default(null),
