...
export const toggleableColumns = [
    { id: 'LeaseType', label: 'Tipo' },
    { id: 'LeaseTenant', label: 'Inquilino' },
    { id: 'LeaseRent', label: 'Affitto' },
    { id: 'LeaseExpenses', label: 'Spese accessorie' },
    { id: 'LeaseDeposit', label: 'Deposito' },
    { id: 'LeaseDuration', label: 'Durata' },
    { id: 'LeaseBalance', label: 'Saldo' },
    { id: 'LeaseStatus', label: 'Stato' },
];

const sortOptions = [
    { field: 'propertyTitle', label: 'Proprietà' },
    { field: 'leaseTypeLabel', label: 'Tipo' },
    { field: 'monthlyAmount', label: 'Affitto' },
    { field: 'securityDeposit', label: 'Deposito' },
    { field: 'startDate', label: 'Data di inizio' },
    { field: 'endDate', label: 'Data di fine' },
                        ...
                        >
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="Cerca…"
                                    className="w-full pl-3 pr-8 py-1.5 border border-gray-200 rounded-md text-sm text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#72a333]/30 focus:border-[#72a333]"
                                />
                                <button
                                    type="button"
                                    onClick={() => {
                        ...
                        {openDropdown === 'columns' && (
                            ...
                            >
                                ...
                                {toggleableColumns.map((col) => {
                                    // Default a true a meno che non sia il Saldo (LeaseBalance)
                                    const defaultValue = col.id !== 'LeaseBalance';
                                    const isVisible = columnVisibility[col.id] ?? defaultValue;
