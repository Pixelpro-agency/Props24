...
- Prossimo punto tecnico: A6.4 — Lifecycle dal dettaglio Building
...
> - [ ] A6 — Dettaglio e modifica edificio — **APERTO; A6.1–A6.3 completate; A6.4 prossima**
...
>   - [ ] A6.4 — Lifecycle dal dettaglio Building — **PROSSIMA TASK**
...
Baseline verificata al termine di A6.3: 71 file, 887 test passati, 0 falliti, 0 saltati; build e lint positivi.
